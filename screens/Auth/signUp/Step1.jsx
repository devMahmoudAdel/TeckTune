...
const Step1 = () => {
  ...
  // that useEffect Hook used once while the loading of the screen
  useEffect(() => {
  ...
  const validateInput = (field, value) => {
    ...
    // 2-  validatePassword function

    // that function is used to validate the value of current passed field
    ...
    return !errorMessage; // return boolean ==> yes if error is null - no error -
  };

  const handleInputChange = (field, value) => {
    // that function responsible for the states update.
    switch (field) {
      case "username":
        setUsername(value);
        break;
  ...
  const validateInputs = () => {
    // used to invoke the validateInput for all fields one by one
  ...
  }; // that focus function: indicates at which field we are in ;)
...
const styles = StyleSheet.create({
  ...
  checkbox: {
    ...
    backgroundColor: (agreedToTerms) =>
      agreedToTerms ? "#6055D8" : "transparent",
  },
  termsText: {
    fontSize: 14,
    color: "#555",
